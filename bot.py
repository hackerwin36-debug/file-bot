...
def start(m):
    ...
    if len(parts) > 1 and parts[1] == SECRET:
        bot.send_message(m.chat.id, '⚠️ WARNING! File will be deleted in 1 hour! Download now.')
        f = bot.send_document(m.chat.id, FILE_ID, caption='🔓 Here is your file!')
